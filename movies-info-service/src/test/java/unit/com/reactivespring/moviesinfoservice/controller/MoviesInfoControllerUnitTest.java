...
class MoviesInfoControllerUnitTest {
    ...
    void addMovieInfo() {
        ...
        when(movieInfoServiceMock.addMovieInfo(isA(MovieInfo.class))).thenReturn(Mono.just(new MovieInfo("mockId", "Batman Begins",
                2005, List.of("Christian Bale", "Michael Cane"), LocalDate.parse("2005-06-15"))));
    ...
    void addMovieInfo_validation() {
        ...
        var movieInfo = new MovieInfo(null, "",
                -200, List.of(""), LocalDate.parse("2005-06-15"));
